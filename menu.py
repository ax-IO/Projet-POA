    ...
    def __init__(self, screen, type):
        ...
        if(self.type == 0):  # Victory Menu
            ...
            self.message_display(
                "Vous avez atteint le dernier niveau!", 30, w/2 - 280, 50, GRAY)
            self.message_display(
                "Votre souris est saine et sauve.", 25, w/2 - 220, 90, GRAY)
            self.message_display(
                "Pressez une touche pour quitter le jeu...", 35, w/2 - 350, 200, GRAY)
            self.message_display("Merci d'avoir joué !",
                                 30, w/2 - 150, 250, RED)
            ...
            self.message_display(
                "Vous vous êtes fait mangée!", 30, w/2 - 220, 100, RED)
            self.message_display("Voulez-vous réessayer ?",
                                 38, w/2 - 220, h - 80, WHITE)
